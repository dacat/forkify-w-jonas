...
class RecipeView extends View {
  ...
  /**
   * first half of the pub-sub model
   * @param handler
   */
    ...
    <div class="recipe__details">
      ...
      <div class="recipe__info">
        ...
        <div class="recipe__info-buttons">
          <button data-update-to="${recipe.servings - 1}" class="btn--tiny btn--decrease-servings">
            <svg>
              <use href="${icons}#icon-minus-circle"></use>
            </svg>
          </button>
          <button data-update-to="${recipe.servings + 1}" class="btn--tiny btn--increase-servings">
            <svg>
